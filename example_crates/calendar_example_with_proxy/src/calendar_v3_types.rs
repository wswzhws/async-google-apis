...
pub struct Event {
    ...
    /// DateTime: Last modification time of the main event data (as a RFC3339 timestamp). Updating event reminders will not cause this to change. Read-only.
    #[serde(rename = "updated")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updated: Option<DateTime<Utc>>,
...
pub struct EventWorkingLocationProperties {
    ...
    /// ANY data: If present, specifies that the user is working at home.
...
impl std::default::Default for EventsListEventTypes {
    fn default() -> EventsListEventTypes {
        EventsListEventTypes::Undefined
    }
}

impl std::fmt::Display for EventsListEventTypes {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            EventsListEventTypes::Undefined => write!(f, "undefined"),
            EventsListEventTypes::Birthday => write!(f, "birthday"),
            EventsListEventTypes::Default => write!(f, "default"),
            EventsListEventTypes::FocusTime => write!(f, "focusTime"),
            EventsListEventTypes::FromGmail => write!(f, "fromGmail"),
            EventsListEventTypes::OutOfOffice => write!(f, "outOfOffice"),
            EventsListEventTypes::WorkingLocation => write!(f, "workingLocation"),
        };
        Ok(())
    }
}
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize)]
pub enum EventsWatchEventTypes {
    Undefined,
    /// Special all-day events with an annual recurrence.
    #[serde(rename = "birthday")]
    Birthday,
...
impl std::default::Default for EventsWatchEventTypes {
    fn default() -> EventsWatchEventTypes {
        EventsWatchEventTypes::Undefined
    }
}

impl std::fmt::Display for EventsWatchEventTypes {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            EventsWatchEventTypes::Undefined => write!(f, "undefined"),
            EventsWatchEventTypes::Birthday => write!(f, "birthday"),
            EventsWatchEventTypes::Default => write!(f, "default"),
            EventsWatchEventTypes::FocusTime => write!(f, "focusTime"),
            EventsWatchEventTypes::FromGmail => write!(f, "fromGmail"),
            EventsWatchEventTypes::OutOfOffice => write!(f, "outOfOffice"),
            EventsWatchEventTypes::WorkingLocation => write!(f, "workingLocation"),
        };
        Ok(())
    }
}
...
pub struct EventsListParams {
    ...
    pub event_types: Option<EventsListEventTypes>,
...
impl std::fmt::Display for EventsListParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        if let Some(ref v) = self.event_types {
            write!(
                f,
                "&eventTypes={}",
                percent_encode(format!("{}", v).as_bytes(), NON_ALPHANUMERIC).to_string()
...
pub struct EventsWatchParams {
    ...
    /// Event types to return. Optional. This parameter can be repeated multiple times to return events of different types. If unset, returns all event types.
    #[serde(rename = "eventTypes")]
    pub event_types: Option<EventsWatchEventTypes>,
    /// Specifies an event ID in the iCalendar format to be provided in the response. Optional. Use this if you want to search for an event by its iCalendar ID.
    #[serde(rename = "iCalUID")]
    pub i_cal_u_i_d: Option<String>,
    /// The maximum number of attendees to include in the response. If there are more than the specified number of attendees, only the participant is returned. Optional.
    ...
    C::Response: hyper_util::client::legacy::connect::Connection,
{
    ...
    pub async fn delete(&self, params: &AclDeleteParams) -> Result<()> {
        ...
        headers.push((
            ...
            format!("Bearer {token}", token = tok.token().unwrap()),
        ));
